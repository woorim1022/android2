...
public class MainActivity extends AppCompatActivity {
    ...
    private void init() {
        ...
        ImageGridAdapter imageGridAdapter = new ImageGridAdapter(this, imageIDs, fileNames, null, null);
        ...
        if (requestCode == 3) {
            ...
            if (resultCode == RESULT_OK) {
                try {
                    ...
                    // 이미지뷰에 세팅
                    GridView gridViewImages = findViewById(R.id.gridViewImages);
                    ImageGridAdapter imageGridAdapter = new ImageGridAdapter(this, imageIDs, fileNames, img, "hi");
                    gridViewImages.setAdapter(imageGridAdapter);
